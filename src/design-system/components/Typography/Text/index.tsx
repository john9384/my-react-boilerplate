...
import { FontSize } from 'design-system/constants/FontSize';
...
export interface BoldTextProps extends TextProps {
  weight?: 200 | 400 | 600 | 800 | 1000 | 'bolder';
}
...
export const Text: React.FC<TextProps> = styled.p<TextProps>`
...
export const BoldText: React.FC<BoldTextProps> = styled.strong<BoldTextProps>`
  display: block;
  color: ${({ color, colorType, theme }) => {
